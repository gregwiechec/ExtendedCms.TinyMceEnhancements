...
namespace Alloy.Sample
{
    internal static class InternalServiceCollectionExtensions
    {
        ...
        public static IServiceCollection AddUIMappedFileProviders(this IServiceCollection services, string applicationRootPath, string uiSolutionRelativePath)
        {
            ...
            {
                c.BasePathFileProviders.Add(new MappingPhysicalFileProvider("/EPiServer/ExtendedCms.TinyMceEnhancements", string.Empty, Path.Combine(uiSolutionFolder, @"src\ExtendedCms.TinyMceEnhancements")));
            });
            return services;
        }
    }
